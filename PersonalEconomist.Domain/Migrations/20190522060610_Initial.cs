        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<double>(maxLength: 36, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(nullable: true),
                    IsMain = table.Column<short>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: false),
                    IsDeleted = table.Column<short>(type: "bit", nullable: false),
                    CounterId = table.Column<byte[]>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: false),
                    IsDeleted = table.Column<short>(type: "bit", nullable: false),
                    CreditCardId = table.Column<byte[]>(nullable: false),
                    Amount = table.Column<double>(nullable: false),
                    Date = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: false),
                    IsDeleted = table.Column<short>(type: "bit", nullable: false),
                    TransactionId = table.Column<byte[]>(nullable: true),
                    ItemId = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
